...
const Trusted = () => {
  ...
  return (
    <section className="w-screen bg-green-main py-20 relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] px-4">
      <div className="max-w-6xl mx-auto">
        {/* Title */}
        <h1 className="text-3xl md:text-5xl font-bold text-black mb-12 text-center">
          Trusted Stack by{" "}
          <span className="italic text-white drop-shadow-[0_0_3px_white]">
            AgraBanyu
          </span>
        </h1>
